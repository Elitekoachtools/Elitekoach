...
const coaches: CoachQuote[] = [
  {
    id: 1,
    quote: "A great coach can bring out the best in you—someone who challenges you to be better and holds you accountable.",
    name: "Serena Williams",
    image: "https://images.pexels.com/photos/16559924/pexels-photo-16559924.jpeg",
    role: "Elite Talent"
  },
  {
    id: 2,
    quote: "Coaching is taking a player where they can't take themself. It's about vision and discipline.",
    name: "José Mourinho",
    image: "https://framerusercontent.com/images/LsDMiOgVB6wZKulQObDZTVbs.jpg",
    role: "Football Manager"
  },
  {
    id: 3,
    quote: "People who succeed at the highest level are the ones who continuously invest in themselves.",
    name: "Tony Robbins",
    image: "https://framerusercontent.com/images/EgoeQXpeOf42WAYJaSQDxnn1zak.webp",
    role: "Success Coach"
  }
];
        ...
        <div className="max-w-6xl mx-auto relative group">
          <div className="bg-white rounded-[40px] overflow-hidden shadow-[0_40px_100px_rgba(0,0,0,0.1)] flex flex-col md:flex-row min-h-[500px]">
            <div className="flex-1 p-12 lg:p-20 flex flex-col justify-center transition-all duration-500 animate-in fade-in slide-in-from-left-4">
              <svg width="48" height="38" viewBox="0 0 48 38" fill="none" className="mb-10 text-brand-bg/20">
              ...
              <div className="space-y-10">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-xs font-bold text-brand-bg/40 uppercase tracking-widest">{coach.role}</p>
                </div>
              </div>
            </div>

            <div className="relative w-full md:w-1/2 lg:w-[45%] h-[400px] md:h-auto overflow-hidden">
              <img
                key={coach.id}
                src={coach.image}
                alt={coach.name}
          ...
          <div className="absolute top-1/2 -left-6 lg:-left-12 -translate-y-1/2 hidden sm:block">
            <button 
                onClick={() => setCurrent((prev) => (prev - 1 + coaches.length) % coaches.length)}
