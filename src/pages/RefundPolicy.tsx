      ...
      <main className="pt-32 pb-20">
        <div className="section-container max-w-3xl">
          ...
          <div className="space-y-8 text-white/80 text-[15px] leading-relaxed font-sans">
            <GlassCard>
              <h3 className="text-white font-bold text-lg mb-3 font-sans uppercase tracking-wider">1. Cancellation Period</h3>
              <p>You may cancel your subscription or booking at any time. Cancellations will take effect at the end of your current billing period unless otherwise stated. No refunds will be issued for the remaining days of the current period unless required by applicable law.</p>
            </GlassCard>

            <GlassCard>
              <h3 className="text-white font-bold text-lg mb-3 font-sans uppercase tracking-wider">2. Refund Eligibility</h3>
              <p>Refunds are considered on a case-by-case basis. Eligible refunds may include duplicate payments, technical issues preventing access to paid services, or other circumstances as determined by EliteKoach at our sole discretion.</p>
            </GlassCard>
            ...
            <GlassCard>
              <h3 className="text-white font-bold text-lg mb-3 font-sans uppercase tracking-wider">4. Missed Sessions and No-Shows</h3>
              <p>If you miss a booked coaching session without prior cancellation, you may not be eligible for a refund or reschedule. Please refer to the specific cancellation policy communicated at the time of booking.</p>
            </GlassCard>
