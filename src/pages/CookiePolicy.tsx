      ...
      <main className="pt-32 pb-20">
        <div className="section-container max-w-3xl">
          <div className="mb-12">
            ...
            <h1 className="text-brand-accent font-sans uppercase tracking-widest text-xs font-bold mb-4">Cookie Policy</h1>
          ...
          <div className="space-y-8 text-white/80 text-[15px] leading-relaxed font-sans">
            <GlassCard>
              <h3 className="text-white font-bold text-lg mb-3 font-sans uppercase tracking-wider">What Are Cookies</h3>
              <p>Cookies are small text files placed on your device when you visit our website. They help us improve your experience, understand how you use our site, and personalise content.</p>
            </GlassCard>

            <GlassCard>
              <h3 className="text-white font-bold text-lg mb-3 font-sans uppercase tracking-wider">Types of Cookies We Use</h3>
              <p><strong>Essential cookies:</strong> Required for the website to function properly. These cannot be disabled.</p>
              <p className="mt-3"><strong>Analytics cookies:</strong> Help us understand how visitors interact with our website so we can improve performance and content.</p>
              <p className="mt-3"><strong>Functional cookies:</strong> Remember your preferences and settings to provide a more personalised experience.</p>
            </GlassCard>

            <GlassCard>
              <h3 className="text-white font-bold text-lg mb-3 font-sans uppercase tracking-wider">Managing Cookies</h3>
              <p>You can control or disable cookies through your browser settings. Please note that disabling essential cookies may affect the functionality of our website.</p>
            </GlassCard>

            <GlassCard>
              <h3 className="text-white font-bold text-lg mb-3 font-sans uppercase tracking-wider">Third-Party Cookies</h3>
              <p>We may use trusted third-party services that may set cookies on your device. These services help us analyse usage and improve our platform. We do not control these third-party cookies.</p>
            </GlassCard>

            <GlassCard>
              <h3 className="text-white font-bold text-lg mb-3 font-sans uppercase tracking-wider">Contact Us</h3>
              <p>If you have questions about our Cookie Policy, please contact us at support@elitekoach.com or through the contact form on our website.</p>
            </GlassCard>
          </div>
        </div>
      </main>
